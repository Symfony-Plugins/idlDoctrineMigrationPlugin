 ...
 *
 * Source code has been provide by Thomas Rabaix from his plugin swToolboxPlugin, avaliable here:
 *   http://github.com/rande/swToolboxPlugin/blob/sf1.3/lib/task/swDoctrineMigrateTask.class.php
 * So the LICENCE applicable is the one of the swToolboxPlugin:
 *   http://github.com/rande/swToolboxPlugin/blob/sf1.3/LICENSE
 */


/**
 * swDoctrineMigrateTask does the same as doctrine:migrate but process the migration ONE BY ONE !!!';
 * @package    idlDoctrineMigrationPlugin  (imported from swToolbox)
